...
export default function Home(props: {
  ...
  const [dbProducts, setDbProducts] = useState<Product[]>(props.initialDbProducts);
  ...
  useEffect(() => {
    const startAudio = () => {
      if (sitarAudioRef.current && sitarAudioRef.current.paused) {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#0d0405] text-neutral-100">
      <div className="min-h-[100dvh] bg-luxury-gradient-dark relative overflow-hidden max-w-[1280px] mx-auto xl:border-l xl:border-r xl:border-[#dfba73]/15 xl:shadow-[0_0_80px_rgba(0,0,0,0.8)]">
      ...
      <section id="home" className="relative min-h-[600px] lg:h-[100dvh] flex items-center justify-center overflow-hidden pt-[160px] pb-12 md:pt-[180px] lg:pt-[140px]">
        ...
        <div className="absolute top-[170px] right-24 z-20 hidden md:block">
          <div className="w-24 h-24 rounded-full border-2 border-[#dfba73]/40 bg-neutral-950/80 backdrop-blur-xs flex items-center justify-center p-2 shadow-2xl relative group hover:border-[#dfba73] transition-colors duration-500">
            {/* Spinning gold text border inside seal */}
          ...
          <span className="block text-center font-sans text-[7px] tracking-widest text-[#dfba73] uppercase mt-1.5 font-bold">OJ Purity Seal</span>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <span
                    contentEditable={isDesignMode}
                    suppressContentEditableWarning
                    onBlur={(e) => handleTextChange(`sil_cat_label_${space.id}`, e.currentTarget.textContent || "")}
                    className={`font-serif text-[11px] sm:text-xs leading-tight font-medium ${editOutlineClass} ${
                  ...
                  <span
                    contentEditable={isDesignMode}
                    suppressContentEditableWarning
                    onBlur={(e) => handleTextChange(`sil_cat_sub_${space.id}`, e.currentTarget.textContent || "")}
                    className={`font-sans text-[7px] sm:text-[8px] text-neutral-500 tracking-wider uppercase mt-1 ${editOutlineClass}`}
                  >
                    {spaceSub}
                  </span>
                </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8">
          {products
            ...
            .filter((p) => {
              ...
              const cleanSub = p.subCategory.toLowerCase().replace(/[^a-zA-Z0-9]/g, "");
